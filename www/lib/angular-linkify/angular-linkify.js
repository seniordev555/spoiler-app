  ...
  .filter('linkify', function () {
      ...
      function linkify (_str, type) {
        ...
        // console.log(url);
          ...
          anch.setAttribute('onclick', 'window.open(' + url + ', '+ target + ')');
        ...
        // Twitter
        if (type === 'twitter') {
          _text = _text.replace(/(|\s)*@([\u00C0-\u1FFF\w]+)/g, '$1<a href="https://twitter.com/$2" target="_blank", location="yes">@$2</a>');
          _text = _text.replace(/(^|\s)*#([\u00C0-\u1FFF\w]+)/g, '$1<a href="https://twitter.com/search?q=%23$2" target="_blank", location="yes">#$2</a>');
        }


        // Github
        if (type === 'github') {
          _text = _text.replace(/(|\s)*@(\w+)/g, '$1<a href="https://github.com/$2" target="_blank" location="yes">@$2</a>');
        }
