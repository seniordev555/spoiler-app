...
(function (root, factory) {
  ...
  angular.module('angucomplete-alt', [] )
    ...
    var TEXT_NORESULTS = 'No keywords found';
    ...
    return {
      ...
      link: function(scope, elem, attrs, ctrl) {
        ...
        function handleRequired(valid) {
          ...
          //console.log("this is the handleRequired function: " + validState);
        ...
        //  console.log("This is every time you type a character: "+scope.searchStr);
        ...
        scope.selectResult = function(result) {
          ...
          if (scope.matchClass) {
            ...
            // console.log("This is the result you selected: " + result.title);
          }
